...
以下是Android中视频控制条的表现形式

![control](/img/video/control.png)
...
![video](/img/video/video1.png)

iOS 手机呈现

![video](/img/video/video2.jpg)
...
其实并非所有的浏览器都支持video与audio的所有的编码解码器 这就代表着有时候需要提供多个格式的资源  
